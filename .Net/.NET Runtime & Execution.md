...
### 2. Build Process -- Conversion to IL (Intermediate Language)
...
CLR (Common Language Runtime) is the execution engine of .NET that runs compiled code (IL), manages memory, handles exceptions, and converts IL into native machine code using JIT.
